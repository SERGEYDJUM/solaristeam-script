...
theme: /
    state: Start
        q!: $regex</start>
        q!: * (включи | включить | включай | открой | активируй | запусти | запустить | запускай | играть | поиграть | поиграем | поиграй со мной | сыграем | сыграть | давай играть | давай) *
    ...
    state: ResetGame
        ...
        state: PlayerMoved
            q: [на] $Number::Row (ряд | строка) * $Number::Column (столбец | колонка)
